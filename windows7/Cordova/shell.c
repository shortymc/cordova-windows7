...
{
#ifdef CORDOVA_ENABLE_SCROLLING
# define DUIH_SCROLL DOCHOSTUIFLAG_FLAT_SCROLLBAR
#else
# define DUIH_SCROLL DOCHOSTUIFLAG_SCROLL_NO
#endif
	// Specify some of our UI tastes to the HTML control
	pInfo->cbSize = sizeof(DOCHOSTUIINFO);
	pInfo->dwFlags = DOCHOSTUIFLAG_DISABLE_HELP_MENU | DOCHOSTUIFLAG_DISABLE_SCRIPT_INACTIVE | DOCHOSTUIFLAG_NO3DOUTERBORDER | DUIH_SCROLL |
